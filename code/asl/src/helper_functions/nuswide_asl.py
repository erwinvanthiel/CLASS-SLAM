...
class NusWideFiltered(Dataset):
    def __init__(self, split, path, transform=None, label_indices_positive=None, label_indices_negative=None):
        img_dir= path+'/nus_wide'
        csv_path=path+'/nus_wid_data.csv'
